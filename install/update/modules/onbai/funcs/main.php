...
// xu li
$num_page = "select * from " . NV_PREFIXLANG . "_" . $module_data . "_quessions";
...
$sql_data = "select * from " . NV_PREFIXLANG . "_" . $module_data . "_quessions ORDER BY ID DESC LIMIT " . $first_page . ",10";
...
if ($ts > 1) {
    ...
    if ($ts > 5 and $now_page > 3) {
        $contents .= "<a href=\"" . NV_BASE_SITEURL . "index.php?" . NV_LANG_VARIABLE . "=" . NV_LANG_DATA . "&amp;" . NV_NAME_VARIABLE . "=" . $module_name;
